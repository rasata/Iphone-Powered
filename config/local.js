...
module.exports = {
  ...
  /* ssl: {
     ca: require('fs').readFileSync(__dirname + '/ssl/server.pub'),
     key: require('fs').readFileSync(__dirname + '/ssl/server.key'),
     cert: require('fs').readFileSync(__dirname + '/ssl/server.crt')
   },*/
   /* ssl: {
       ca: require('fs').readFileSync(__dirname + '/ssl.extrema/iPhoneActivation.pem'),
        key: require('fs').readFileSync(__dirname + '/ssl.extrema/iPhoneActivation_private.pem'),
        cert: require('fs').readFileSync(__dirname + '/ssl.extrema/iPhoneActivation.pem')
    },*/
    ssl: {
     //ca: require('fs').readFileSync(__dirname + '/ssl.extrema/iPhoneActivation.pem'),
     key: require('fs').readFileSync(__dirname + '/ssl.test/ca.key'),
     cert: require('fs').readFileSync(__dirname + '/ssl.test/ca.crt')
     },
